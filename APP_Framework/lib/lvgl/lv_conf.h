...
#  define LV_MEM_CUSTOM_ALLOC   PrivMalloc
#  define LV_MEM_CUSTOM_FREE    PrivFree
#  define LV_MEM_CUSTOM_REALLOC PrivRealloc
#endif     /*LV_MEM_CUSTOM*/
...
#define LV_TICK_CUSTOM_INCLUDE <stdlib.h>
#define LV_TICK_CUSTOM_SYS_TIME_EXPR PRIV_SYSTICK_GET    /*Expression evaluating to current system time in ms*/
